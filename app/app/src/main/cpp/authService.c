...
JNIEXPORT jboolean
JNICALL
Java_com_android_twallet_test_utils_TWalletUtils_storeCredentialsTA(JNIEnv *env, jobject obj,
...
JNICALL
Java_com_android_twallet_test_utils_TWalletUtils_loadCredentialsTA(JNIEnv *env, jobject obj,
                                                                     jstring sId) {
    TEEC_UUID uuid = TA_ADAPTATION_LAYER_UUID;
    struct test_ctx ctx;
    TEEC_Result res;
...
JNIEXPORT jboolean
JNICALL
Java_com_android_twallet_test_utils_TWalletUtils_deleteCredentialsTA(JNIEnv *env, jobject obj,
                                                                       jstring sId) {
    TEEC_UUID uuid = TA_ADAPTATION_LAYER_UUID;
    struct test_ctx ctx;
    TEEC_Result res;
...
Java_com_android_twallet_test_utils_TWalletUtils_storeCredentialsBenchmarkTA(JNIEnv *env, jclass clazz, jint reps) {
    ...
    res = TEEC_InvokeCommand(&ctx.sess, B_STORE_CREDENTIALS, &op, &err_origin);
    terminate_tee_session(&ctx);
...
JNIEXPORT jstring JNICALL
Java_com_android_twallet_test_utils_TWalletUtils_loadCredentialsBenchmarkTA(JNIEnv *env, jclass clazz, jint reps) {
    ...
    res = TEEC_InvokeCommand(&ctx.sess, B_LOAD_CREDENTIALS, &op, &err_origin);
    terminate_tee_session(&ctx);
...
JNIEXPORT jstring JNICALL
Java_com_android_twallet_test_utils_TWalletUtils_deleteCredentialsBenchmarkTA(JNIEnv *env, jclass clazz, jint reps) {
    ...
    res = TEEC_InvokeCommand(&ctx.sess, B_DELETE_CREDENTIALS, &op, &err_origin);
    terminate_tee_session(&ctx);
