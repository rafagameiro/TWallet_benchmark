...
public class AuthServiceNWTests extends AppCompatActivity {

    private static final String FILENAME_OUTPUT = "/outputs/authentication-nw-%s-output-%s.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_authentication_normal_world);
                ...
                new Thread(() -> {
                    ...
                    if (testAuthentication[0].isChecked()) {
                        for (int i = 0; i < iterations; i++) {
                            ...
                            tWalletUtils.storeCredentials("id" + i, "address" + i, "pass" + i);
                    ...
                    if (testAuthentication[1].isChecked()) {
                        for (int i = 0; i < iterations; i++) {
                            long startTime = System.currentTimeMillis();
                            tWalletUtils.loadCredentials("id" + i);
                            values[i] = System.currentTimeMillis() - startTime;
                    ...
                    if (testAuthentication[2].isChecked()) {
                        for (int i = 0; i < iterations; i++) {
                            long startTime = System.currentTimeMillis();
                            tWalletUtils.deleteCredentials("id" + i);
                            values[i] = System.currentTimeMillis() - startTime;
