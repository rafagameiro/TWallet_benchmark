...
public class AuthServiceMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_test_auth_menu);

        /* initializing wComponentsButton */
        normalWorldButton = findViewById(R.id.FromNormalWorld);

        /* initializing woutComponentsButton */
        secureWorldButton = findViewById(R.id.FromSecureWorld);
        ...
        normalWorldButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(AuthServiceMenu.this, AuthServiceNWTests.class));
            }
        });
        ...
        secureWorldButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                startActivity(new Intent(AuthServiceMenu.this, AuthServiceSWTests.class));
            }
        });
