...
/*
* B_GENERATE_KEYS - Generates and stores the generated keys used for the tests
...
/*
* B_ATTESTATION_GET_PROOF - Generates and sends back an attestation proof of all secure components
* param[0] (value) Nonce send from the Normal World
* param[1] (memref) Attestation proof
* param[2] unused
* param[3] unused
...
/*
* B_ATTESTATION_GET_PROOF_EC - Same as B_ATTESTATION_GET_PROOF, but uses EC
* param[0] (value) Nonce send from the Normal World
* param[1] (memref) Attestation proof
* param[2] unused
* param[3] unused
